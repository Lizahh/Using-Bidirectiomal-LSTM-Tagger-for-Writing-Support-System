...
# it means Instantly make your loops show a smart progress meter - just wrap any iterable with tqdm(iterable), and you’re done!
from tqdm import tqdm

# recordclass is used to produce a mutable-named-tuple. mutable means changeable and named_tuple means jis tuple ka naam b ho. 
...
# For cuda, you can use the following to reproduce the same result each time to avoid non-deterministic behaviour 
torch.backends.cudnn.deterministic = True


# This function will print the log messages. they manipulated the output message in their own way
